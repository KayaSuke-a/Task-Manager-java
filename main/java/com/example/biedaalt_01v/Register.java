package com.example.biedaalt_01v;
...
public class Register extends AppCompatActivity {
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://biedaalt02-4b66d-default-rtdb.firebaseio.com/");
